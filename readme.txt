...
* **For everyone:**
	...
	* **Improved:**
		...
		* TODO Plugin conflict notices are now in red. NOTESELF: add "attention" class, attention function?.
		* TODO This plugin now detects Elementor as a conflicting plugin for content. This means that when Elementor builds a page, no automated description can be generated from the content.
	* **Changed:**
