...
* **For everyone:**
	...
	* **Changed:**
		...
		* The sitemap's "generated by" mark now leads to our homepage, instead of the plugin page. The URL is still invisible and otherwise blocked from robots, and can be easily removed using the [Incognito extension](https://theseoframework.com/extensions/incognito/).
	* **Removed:**
