...
* **Added:**
	...
	* You can now set robots settings for all taxonomies, and much less confusingly so.
	* The new WordPress core sitemaps are now disabled when you enable sitemaps via TSF.
	...
	* Thanks to the intelligent content parsing brought in TSF v3.2.4, content generated by these page builders can now be used reliably for description generation:
		* Elementor.
		* Beaver Builder.
	...
	* You can now choose to remove the blog name from autogenerated social titles (Open Graph, Twitter).
