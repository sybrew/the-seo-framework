...
* **Not fixed:**
	...
	* **Titles:**
		...
		* Some WordPress character texturizations aren't converted in the title inputs, only conditionally in the placeholders, and always in the tags. For example, `--` should become `&mdash;` (`&amp;mdash;`).
