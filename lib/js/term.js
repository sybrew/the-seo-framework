...
window.tsfTerm = function( $ ) {
	 ...
	 * @type {string}
	 */
	const _ogTitleId = 'autodescription-meta[og_title]';
	/**
	 * @since 4.2.0
	 * @access private
	 * @type {string}
	 */
	const _ogDescId = 'autodescription-meta[og_description]';
	 ...
	 * @type {string}
	 */
	const _twTitleId = 'autodescription-meta[tw_title]';
	/**
	 * @since 4.2.0
	 * @access private
	 * @type {string}
	 */
	const _twDescId = 'autodescription-meta[tw_description]';
