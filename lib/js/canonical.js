...
window.tsfCanonical = function () {
	...
	/**
	 * @since 5.1.0
	 * @since 5.1.3 1. Made private.
	 *              2. Changed from string to object.
	 * @access private
	 * @type {{scheme:String,host:String,port:String,path:String}}
	 */
	const rootUrl = l10n.params.rootUrl;

	/**
	 * @since 5.1.0
	 * @since 5.1.3 Made private.
	 * @access private
	 ...
	 * @type {Boolean}
	 */
	const allowCanonicalURLNotationTracker = l10n.params.allowCanonicalURLNotationTracker;
	...
	function sanitizeSlug( slug ) {
		...
		return encodeURIComponent( slug );            // Encode to ISO-8859-1
	}
