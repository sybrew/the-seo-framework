 ...
 * @since 3.3.0: All other JS files are reliable for API-use.
 */
...
window.tsf = {
	...
	_initTitleInputs: function() {
		...
		const setHoverAdditionsValue = function() {
			...
			if ( tsf.states.isSettingsPage ) {
				...
				//= Global or home additions are enabled.
				if ( useTagline )
	...
	_initSocialTitleInputs: function() {
		...
		let $ogTitle = jQuery( "#autodescription_og_title, #autodescription-meta\\[og_title\\], #autodescription-site-settings\\[homepage_og_title\\]" ),
			$twTitle = jQuery( "#autodescription_twitter_title, #autodescription-meta\\[tw_title\\], #autodescription-site-settings\\[homepage_twitter_title\\]" ),
	...
	_initSocialDescInputs: function() {
		...
		let $ogDesc = jQuery( "#autodescription_og_description, #autodescription-meta\\[og_description\\], #autodescription-site-settings\\[homepage_og_description\\]" ),
			$twDesc = jQuery( "#autodescription_twitter_description, #autodescription-meta\\[tw_description\\], #autodescription-site-settings\\[homepage_twitter_description\\]" ),
