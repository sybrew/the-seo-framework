...
window.tsf = function( $ ) {
	...
	const _initPostboxToggle = () => {
		...
		let $handles = $( '.postbox[id^="autodescription-"], .postbox#tsf-inpost-box' ).find( '.hndle, .handlediv' );
	...
	return Object.assign( {
		...
		load: () => {
			...
			// "Overall, I found that pages with external (not in the HTML) CSS, JavaScript, or fonts could lead to inaccurate estimations of domInteractive"
