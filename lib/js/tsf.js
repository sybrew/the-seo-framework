...
window.tsf = {
	...
	dynamicPlaceholder: function( event ) {
		...
		if ( typeof $tagbox !== "undefined" && $tagbox.length > 0 && ! $tagbox.is( ':checked' ) ) {
			...
			let offsetWidth = 0,
				...
				horPad = ( outerWidth - $this.width() ) / 2,
	...
	ready: function( jQ ) {
		...
		// Do resize functionality.
		jQ( document.body ).ready( tsf._doResizeListener );
