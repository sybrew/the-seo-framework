...
window.tsfSettings = function( $ ) {
	...
	const _initTitleSettings = () => {
		...
		const updateSeparator = ( event ) => {
			...
			separator = tsf.decodeEntities( entity );
	...
	const _initHomeTitleSettings = () => {
		...
		tsfTitle.updateStateFor( titleId, 'defaultTitle', state.defaultTitle.trim() );
		...
		tsfTitle.updateStateFor( titleId, 'additionValue', state.additionValue.trim() );
	...
	const _initHomeDescriptionSettings = () => {
		...
		tsfDescription.updateStateFor( descId, 'defaultDescription', state.defaultDescription.trim() );
