...
window.tsfSettings = function( $ ) {
	...
	const _initHomeSocialSettings = () => {
		const _titleId = _getSettingsId( 'homepage_title' ),
			  _descId  = _getSettingsId( 'homepage_description' );

		const _ogTitleId = _getSettingsId( 'homepage_og_title' ),
			  _ogDescId  = _getSettingsId( 'homepage_og_description' ),
			  _twTitleId = _getSettingsId( 'homepage_twitter_title' ),
			  _twDescId  = _getSettingsId( 'homepage_twitter_description' );
