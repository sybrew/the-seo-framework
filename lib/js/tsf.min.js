...
imageWidth:l,imageHeight:h,minWidth:g>f?f:g,minHeight:n>k?k:n,x1:c,y1:m,x2:f+c,y2:k+m};!1===e&&!1===d&&(g.Ea=f+":"+k);!0===e&&(g.minHeight=200,g.maxWidth=l);!0===d&&(g.minWidth=200,g.maxHeight=h);return g},ea:function(a,b,c,d){return c<=a&&d<=b?!1:!0},ga:function(){jQuery(".tsf-remove-social-image").off("click",tsf.s);jQuery(".tsf-remove-social-image").on("click",tsf.s)},na:function(){jQuery(".tsf-set-social-image").off("click",tsf.I);jQuery(".tsf-remove-social-image").off("click",tsf.s);jQuery(".tsf-set-social-image").on("click",
tsf.I);jQuery(".tsf-remove-social-image").on("click",tsf.s)},U:function(){var a=jQuery(".tsf-set-social-image");if(a.length){var b="",c="";jQuery.each(a,function(a,e){b=jQuery(e).data("inputid");c=jQuery("#"+b+"-id");c.length&&0<c.val()&&(jQuery("#"+b+"-url").prop("readonly",!0),tsf.D(jQuery(e),b,!1));jQuery("#"+b+"-url").val()&&jQuery("#"+b+"-select").text(tsf.other[b].change)})}},la:function(){var a=jQuery(".tsf-color-picker");a.length&&jQuery.each(a,function(a,c){var b=jQuery(c),e="",f=b.data("tsf-default-color");
b.wpColorPicker({defaultColor:f,width:238,change:function(){e=b.wpColorPicker("color");""===e&&(e=f);b.val(e);tsf.l()},clear:function(){b.parent().siblings(".wp-color-result").css("backgroundColor",f);tsf.l()},palettes:!1})})},oa:function(){tsf.B=tsf.params.titleSeparator;tsf.F=tsf.params.descriptionSeparator;tsf.m=tsf.states.titleTagline;tsf.a=parseInt(tsf.states.counterType);tsf.c=tsf.states.hasInput},O:function(){if(tsf.c){var a=jQuery;a("#tsf-title-tagline-toggle :input").on("click",tsf.va);a("#tsf-title-location input").on("click",
tsf.wa);a("#title-prefixes-toggle :input").on("click",tsf.xa);a("#autodescription-site-settings\\[homepage_title\\]").on("input",tsf.ya);a("#tsf-home-title-location :input, #tsf-title-tagline-toggle :input, #tsf-title-separator input").on("click",tsf.j);a("#autodescription-site-settings\\[homepage_title_tagline\\]").on("input",tsf.A);a("#homepage-tab-general").on("tsf-tab-toggled",tsf.j);a("#autodescription-homepage-settings > button").on("click",tsf.j);a("#tsf-inpost-box > button").on("click",tsf.j);
a("#autodescription-site-settings\\[title_rem_additions\\]").on("click",tsf.za);tsf.h().on("input",tsf.Z);a("#tsf-title-placeholder").on("click",tsf.ha);a(window).resize(tsf.sa)}},N:function(){if(jQuery(".tsf-flex").length){tsf.P();var a=0,b={},c=0,d=jQuery(".tsf-flex-nav-tab-wrapper");jQuery(window).on("tsf-flex-resize",function(){clearTimeout(a);var e=0;a=setTimeout(function(){if(d.length){var a=jQuery(".tsf-flex-nav-tab-inner"),c=d.width(),l=a.width(),h=jQuery(".tsf-flex-nav-name");b.b||(b.b={},
b.b.v=0,b.b.da=0,b.b.w=1);!b.b.w&&b.b.v<c&&(h.fadeIn(250),setTimeout(function(){l=a.width()},e));setTimeout(function(){l>c?(h.hide(),b.b.w=0):b.b.v<c&&(h.fadeIn(250),b.b.w=1)},2*e);setTimeout(function(){b.b.v=c;b.b.da=l},3*e)}},c);e=10;c=75});jQuery(window).trigger("tsf-flex-resize")}},P:function(){jQuery(window).on("resize orientationchange",tsf.o);jQuery("#collapse-menu").click(tsf.o);jQuery(".columns-prefs :input[type=radio]").change(tsf.o);jQuery(".meta-box-sortables").on("sortupdate",tsf.o)},
o:function(){jQuery(window).trigger("tsf-flex-resize")},R:function(){jQuery(document.body).trigger("tsf-ready")},ready:function(a){tsf.oa();a("div.updated, div.error, div.notice-warning").insertAfter("div.tsf-top-wrap");a(document.body).ready(tsf.O);a(document.body).ready(tsf.ma);a(document.body).ready(tsf.C);a(document.body).ready(tsf.ua);a(document.body).ready(tsf.statusBarHover);a(document.body).ready(tsf.na);a(document.body).ready(tsf.U);a(document.body).ready(tsf.la);a(document.body).ready(tsf.T);
a(document.body).ready(tsf.fa);a(document.body).ready(tsf.R);a(document.body).ready(tsf.N);a(document.body).on("click touchstart MSPointerDown",tsf.Aa);tsf.G().on("input",tsf.M);tsf.h().on("input",tsf.u);a("#tsf-title-separator input").on("click",tsf.ja);a("#tsf-description-separator input").on("click",tsf.ia);a(".tsf-js-confirm-reset").on("click",tsf.V);a(".tsf-tabs-radio").on("change",tsf.ra);a(".tsf-flex-nav-tab-radio").on("change",tsf.ca);a("#tsf-description-onblogname-toggle :input").on("click",
