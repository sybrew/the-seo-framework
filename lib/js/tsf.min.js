...
0<d.val()&&(jQuery("#"+b+"-url").prop("readonly",!0),tsf.s(jQuery(e),b,!1));jQuery("#"+b+"-select").text(tsf.other[b].change)})}},ca:function(){var a=jQuery(".tsf-color-picker");a.length&&jQuery.each(a,function(a,d){var b=jQuery(d),e="",f=b.data("tsf-default-color");b.wpColorPicker({defaultColor:f,width:238,change:function(){e=b.wpColorPicker("color");""===e&&(e=f);b.val(e);tsf.h()},clear:function(){b.parent().siblings(".wp-color-result").css("backgroundColor",f);tsf.h()},palettes:!1})})},ea:function(){tsf.m=
tsf.params.titleSeparator;tsf.u=tsf.params.descriptionSeparator;tsf.j=tsf.states.titleTagline;tsf.a=tsf.states.counterType;tsf.f=tsf.states.hasInput},ready:function(a){tsf.ea();a("div.updated, div.error, div.notice-warning").insertAfter("div.tsf-top-wrap");a(document.body).ready(tsf.o);a(document.body).ready(tsf.R);a(document.body).ready(tsf.ka);a(document.body).ready(tsf.statusBarHover);a(document.body).on("click touchstart MSPointerDown",tsf.W);a(document.body).ready(tsf.da);a(document.body).ready(tsf.L);
a(document.body).ready(tsf.ca);a(document.body).ready(tsf.K);a(document.body).ready(tsf.U);tsf.v().on("input",tsf.I);tsf.c().on("input",tsf.l);a("#tsf-title-separator input").on("click",tsf.aa);a("#tsf-description-separator input").on("click",tsf.Z);a(".tsf-js-confirm-reset").on("click",tsf.M);a(".tsf-tab").on("click",tsf.ia);a("#tsf-title-tagline-toggle :input").on("click",tsf.la);a("#tsf-title-location input").on("click",tsf.ma);a("#title-prefixes-toggle :input").on("click",tsf.na);a("#tsf-description-onblogname-toggle :input").on("click",
tsf.ja);a("#tsf-description-additions-toggle :input").on("click",tsf.J);a("#autodescription-site-settings\\[homepage_title\\]").on("input",tsf.oa);a("#tsf-home-title-location :input, #tsf-title-tagline-toggle :input, #tsf-title-separator input").on("click",tsf.G);a("#autodescription-site-settings\\[homepage_title_tagline\\]").on("input",tsf.F);a("#homepage-tab-general").on("change",tsf.G);a("#autodescription-site-settings\\[title_rem_additions\\]").on("click",tsf.pa);tsf.c().on("input",tsf.w);a("#tsf-title-placeholder").on("click",
tsf.Y);a(".tsf-dismiss").on("click",tsf.P);a(".tsf-counter").on("click",tsf.N)}};jQuery(tsf.ready);
