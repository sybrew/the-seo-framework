...
tsf.A):jQuery("#autodescription_title").trigger("input",tsf.A);tsf.g=a},sa:function(){var a=0,b=0;jQuery(window).resize(function(){clearTimeout(a);a=setTimeout(function(){var a=jQuery(window).width();b<a?782>=b&&782<=a&&tsf.l():782<=b&&782>=a&&tsf.l();b=a},250)})},za:function(){var a=jQuery(event.target),b=jQuery(".tsf-title-additions-js");a.is(":checked")?b.css("display","none"):b.css("display","inline")},U:function(){tsf.c&&(jQuery(".tsf-metaboxes :input, #tsf-inpost-box .inside :input").not(".tsf-tab :input, .tsf-flex-nav-tab :input").change(function(){tsf.j()}),
...
Ba:function(){tsf.c&&tsf.G().trigger("input",tsf.N)},Ca:function(){tsf.c&&tsf.h().trigger("input",tsf.u)},fa:function(){tsf.g=!1},Z:function(a){var b=jQuery(a.target);b.parents(".tsf-notice").slideUp(200,function(){b.remove()})},ka:function(a){jQuery(a).toggleClass("tsf-loading")},M:function(a,b){var c="tsf-success",d=2500;b||(c="tsf-error",d=5E3);jQuery(a).removeClass("tsf-loading").addClass(c).fadeOut(d)},K:function(a){jQuery(a).stop().empty().prop("class","tsf-ajax").css("opacity","1").removeProp("style")},
X:function(){tsf.a+=1;3<tsf.a&&(tsf.a=0);tsf.C();var a=0;tsf.K(".tsf-counter .tsf-ajax");tsf.ka(".tsf-counter .tsf-ajax");jQuery.ajax({method:"POST",url:ajaxurl,Fa:"json",data:{action:"the_seo_framework_update_counter",nonce:tsf.nonces.edit_posts,val:tsf.a},async:!0,success:function(b){b=jQuery.parseJSON(b);"success"===b.type&&(a=1);tsf.Y(".tsf-counter .tsf-ajax",a)}})},Y:function(a,b){switch(b){case 0:tsf.M(a,!1);break;case 1:tsf.M(a,!0);break;default:tsf.K(a)}},C:function(){if(tsf.c){var a=tsf.a,
...
b.dst_height=d.params.flex_height,b.dst_width=Math.round(b.width/e);"undefined"===typeof b.dst_width&&(b.dst_width=0,b.dst_height=0);return wp.ajax.post("tsf-crop-image",{nonce:tsf.nonces.upload_files,id:a.get("id"),context:"tsf-image",cropDetails:b})}});a.prototype.control={};a.control={params:{flex_width:4096,flex_height:4096,width:1200,height:630}};tsf.cropper=a}},calculateImageSelectOptions:function(a,b){var c=tsf.cropper.control,d=!!parseInt(c.params.flex_width,10),e=!!parseInt(c.params.flex_height,
10),f=parseInt(c.params.width,10),k=parseInt(c.params.height,10),h=a.get("width"),m=a.get("height"),l=f/k,g=f,n=k;b.set("control",c.params);b.set("canSkipCrop",!tsf.ea(c.params.flex_width,c.params.flex_height,h,m));h/m>l?(k=m,f=k*l):(f=h,k=f/l);c=(h-f)/2;l=(m-k)/2;g={handles:!0,keys:!0,instance:!0,persistent:!0,imageWidth:h,imageHeight:m,minWidth:g>f?f:g,minHeight:n>k?k:n,x1:c,y1:l,x2:f+c,y2:k+l};!1===e&&!1===d&&(g.Ea=f+":"+k);!0===e&&(g.minHeight=200,g.maxWidth=h);!0===d&&(g.minWidth=200,g.maxHeight=
m);return g},ea:function(a,b,c,d){return c<=a&&d<=b?!1:!0},ga:function(){jQuery(".tsf-remove-social-image").off("click",tsf.s);jQuery(".tsf-remove-social-image").on("click",tsf.s)},na:function(){jQuery(".tsf-set-social-image").off("click",tsf.J);jQuery(".tsf-remove-social-image").off("click",tsf.s);jQuery(".tsf-set-social-image").on("click",tsf.J);jQuery(".tsf-remove-social-image").on("click",tsf.s)},V:function(){var a=jQuery(".tsf-set-social-image");if(a.length){var b="",c="";jQuery.each(a,function(a,
...
f);tsf.j()},palettes:!1})})},oa:function(){tsf.B=tsf.params.titleSeparator;tsf.F=tsf.params.descriptionSeparator;tsf.m=tsf.states.titleTagline;tsf.a=parseInt(tsf.states.counterType);tsf.c=tsf.states.hasInput},P:function(){if(tsf.c){var a=jQuery;a("#tsf-title-tagline-toggle :input").on("click",tsf.va);a("#tsf-title-location input").on("click",tsf.wa);a("#title-prefixes-toggle :input").on("click",tsf.xa);a("#autodescription-site-settings\\[homepage_title\\]").on("input",tsf.ya);a("#tsf-home-title-location :input, #tsf-title-tagline-toggle :input, #tsf-title-separator input").on("click",
tsf.l);a("#autodescription-site-settings\\[homepage_title_tagline\\]").on("input",tsf.A);a("#homepage-tab-general").on("tsf-tab-toggled",tsf.l);a("#autodescription-homepage-settings > button").on("click",tsf.l);a("#tsf-inpost-box > button").on("click",tsf.l);a("#autodescription-site-settings\\[title_rem_additions\\]").on("click",tsf.za);tsf.h().on("input",tsf.aa);a("#tsf-title-placeholder").on("click",tsf.ha);a(window).resize(tsf.sa)}},O:function(){if(jQuery(".tsf-flex").length){tsf.R();var a=0,b=
{},c=0,d=jQuery(".tsf-flex-nav-tab-wrapper");jQuery(window).on("tsf-flex-resize",function(){clearTimeout(a);var e=0;a=setTimeout(function(){if(d.length){var a=jQuery(".tsf-flex-nav-tab-inner"),c=d.width(),h=a.width(),m=jQuery(".tsf-flex-nav-name");b.b||(b.b={},b.b.v=0,b.b.da=0,b.b.w=1);!b.b.w&&b.b.v<c&&(m.fadeIn(250),setTimeout(function(){h=a.width()},e));setTimeout(function(){h>c?(m.hide(),b.b.w=0):b.b.v<c&&(m.fadeIn(250),b.b.w=1)},2*e);setTimeout(function(){b.b.v=c;b.b.da=h},3*e)}},c);e=10;c=75});
jQuery(window).trigger("tsf-flex-resize")}},R:function(){jQuery(window).on("resize orientationchange",tsf.o);jQuery("#collapse-menu").click(tsf.o);jQuery(".columns-prefs :input[type=radio]").change(tsf.o);jQuery(".meta-box-sortables").on("sortupdate",tsf.o)},o:function(){jQuery(window).trigger("tsf-flex-resize")},S:function(){jQuery(document.body).trigger("tsf-ready")},ready:function(a){tsf.oa();a("div.updated, div.error, div.notice-warning").insertAfter("div.tsf-top-wrap");a(document.body).ready(tsf.P);
a(document.body).ready(tsf.ma);a(document.body).ready(tsf.C);a(document.body).ready(tsf.ua);a(document.body).ready(tsf.statusBarHover);a(document.body).ready(tsf.na);a(document.body).ready(tsf.V);a(document.body).ready(tsf.la);a(document.body).ready(tsf.U);a(document.body).ready(tsf.fa);a(document.body).ready(tsf.S);a(document.body).ready(tsf.O);a(document.body).on("click touchstart MSPointerDown",tsf.Aa);tsf.G().on("input",tsf.N);tsf.h().on("input",tsf.u);a("#tsf-title-separator input").on("click",
tsf.ja);a("#tsf-description-separator input").on("click",tsf.ia);a(".tsf-js-confirm-reset").on("click",tsf.W);a(".tsf-tabs-radio").on("change",tsf.ra);a(".tsf-flex-nav-tab-radio").on("change",tsf.ca);a("#tsf-description-onblogname-toggle :input").on("click",tsf.ta);a("#tsf-description-additions-toggle :input").on("click",tsf.T);a(".tsf-dismiss").on("click",tsf.Z);a(".tsf-counter").on("click",tsf.X)}};jQuery(tsf.ready);
