...
window[ 'autodescription' ] = {
	...
	attachUnsavedChangesListener: function() {
		...
		jQuery( 'div.tsf-metaboxes :input, div#tsf-inpost-box .inside :input' ).not( '.seoframework-tab :input' ).change( function() {
			autodescription.registerChange();
		});

		jQuery( 'div.tsf-metaboxes input[type=text], div.tsf-metaboxes textarea, div#tsf-inpost-box .inside input[type=text], div#tsf-inpost-box .inside textarea' ).not('.nav-tab-wrapper :input').on( 'keyup', function() {
			autodescription.registerChange();
		});
		...
		jQuery( 'div.tsf-metaboxes input[type="submit"], div#publishing-action input[type="submit"], div#save-action input[type="submit"], a.submitdelete' ).click( function() {
	...
	ready: function() {
		...
		jQuery( '#tsf-home-title-location :input, #title-tagline-toggle :input, #tsf-title-separator input' ).on( 'click', autodescription.taglinePropTrigger );
