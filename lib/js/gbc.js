...
window.tsfGBC = function( $ ) {
	 ...
	 *
	 * @since 3.2.0
	 * @since 5.0.7 Added a non-jQuery event alternatives: `tsf-uppdated-block-editor` and `tsf-uppdated-block-editor-${type}`.
	 * @access public
	 *
	 * @function
	 * @param {String} type
	...
	function triggerUpdate( type ) {
		...
		// Unfortunately, we still rely on jQuery here. We can't move away from this, since the data sent is definitely used by other plugins.
