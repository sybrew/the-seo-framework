...
window.tsfAuthorSlugs = function () {
	 ...
	 * @access public
	 *
	 * @param {Object} authors The authors to store.
	 */
	function store( authors ) {
		Object.entries( authors ).forEach( ( [ authorId, authorSlug ] ) => {
			cache.set( +authorId, authorSlug );
		} );
	}
	 ...
	 *
	 * @param {number} authorId The author ID.
	 * @return {Promise} A promise that resolves when the author slug is fetched.
	 */
