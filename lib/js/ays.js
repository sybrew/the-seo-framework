...
window.tsfAys = function( $ ) {
	 ...
	 */
	let l10n = 'undefined' !== typeof tsfAysL10n && tsfAysL10n;
	 ...
	 * @return {string}
	 */
	const querify = elements => elements instanceof Element ? elements
	...
	const _readyAys = () => {
		...
		getChangedState() && console.log( 'Settings were changed prior ready-state. Debug me.' );
