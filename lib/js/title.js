...
window.tsfTitle = function () {
	 ...
	 *
	 * @since 4.0.0
	 * @since 5.0.7 Now always triggers unregistered input to support subpixel
	...
	return Object.assign( {
		...
		enqueueTriggerInput,
		triggerUnregisteredInput,
		enqueueUnregisteredInputTrigger, // FIXME: this should've been enqueueTriggerUnregisteredInput...
	}, {
		l10n,
		untitledTitle,
		privatePrefix,
