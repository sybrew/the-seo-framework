...
window.tsfTitle = function( $ ) {
	...
	const updateStateOf = ( id, part, value ) => {
		...
		if ( 'useSocialTagline' === part ) {
			tsf.deprecatedFunc( 'tsfTitle.updateStateOf( id, \'useSocialTagline\' )', '4.2.0', 'tsfSocial.updateStateOf( id, \'addAdditions\' )' );
			tsfSocial.updateState( id, 'addAdditions', value );
		}
