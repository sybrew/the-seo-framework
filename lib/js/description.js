...
window.tsfDescription = function( $ ) {
	...
	const _loadDescriptionActions = () => {
		...
		// We need to add a new function that allows invoking this behavior, and ?resets? the object cache. -> Or create a new stack?
		// Quick-edit only works via one single input field that's moved about and refilled. We can use that to reset this data, and automatically invoke this whole class without adjustments??/
