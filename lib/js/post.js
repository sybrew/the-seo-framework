...
window.tsfPost = function( $ ) {
	...
	const _initTitleListeners = () => {
		...
		tsfTitle.updateStateFor( _titleId, 'defaultTitle', state.defaultTitle.trim() );
		...
		tsfTitle.updateStateFor( _titleId, 'additionValue', state.additionValue.trim() );
	...
	const _initDescriptionListeners = () => {
		...
		tsfDescription.updateStateFor( _descId, 'defaultDescription', state.defaultDescription.trim() );
		...
		const onSuccess = response => {
			...
			switch ( response.type ) {
				case 'success':
					...
					setTimeout( () => {
						if ( tsfDescription ) {
							tsfDescription.updateStateFor( _descId, 'defaultDescription', response.data.metadescription.trim() );
						}
						if ( tsfSocial ) {
