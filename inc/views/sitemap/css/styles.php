...
$desc_1 = Escape::css_content( \wp_strip_all_tags( Format\Markdown::convert(
...
$desc_2 = Escape::css_content( \wp_strip_all_tags( Format\Markdown::convert(
...
if ( \apply_filters( 'the_seo_framework_indicator_sitemap', true ) ) {
	$footer_content = Escape::css_content( \wp_strip_all_tags( Format\Markdown::convert(
