...
switch ( $instance ) :
	...
	case 'the_seo_framework_social_metabox_twitter' :
		...
		<fieldset id="twitter-cards">
			...
			<?php $this->description_noesc( sprintf( __( 'What kind of Twitter card would you like to use? It will default to %s if no image is found.', 'autodescription' ), $this->code_wrap( 'Summary' ) ) ); ?>
	...
	case 'the_seo_framework_social_metabox_relationships' :
		...
		?><h4><?php _e( 'Link Relationship Settings', 'autodescription' ); ?></h4><?php
