...
/**
 * Override wp_title's bbPress title with the one generated by The SEO Framework.
 * When no title can be generated, fall back to bbPress' supplied title.
 *
 * Still waiting for an API to get the proper title from bbPress (e.g. get raw 'Forum edit: %s')...
 *
...
function _bbpress_filter_title( $title, $args ) {
	...
	$new_title = \apply_filters( 'bbp_raw_title', $new_title, $sep = '&raquo;', $seplocation = '' );
