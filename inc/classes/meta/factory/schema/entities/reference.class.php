<?php
/**
 * @package The_SEO_Framework\Meta\Factory\Schema\Entities\Reference
...
abstract class Reference {
	...
	public static function get_id( $args = null ) { // phpcs:ignore, VariableAnalysis.CodeAnalysis.VariableAnalysis -- trait ref.
		return Factory\URI::get_bare_front_page_canonical_url() . '#/schema/' . current( (array) static::$type );
	}
	...
	public static function &get_dynamic_ref( $args = null ) {
		...
		Factory\Schema::register_entity_writer(
			$id,
			[ __CLASS__, 'write' ],
		);
