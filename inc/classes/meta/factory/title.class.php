...
class Title {
	 ...
	 */
	public static function get_custom_title( $args = null, $escape = true, $social = false ) {
	 ...
	 */
	public static function get_generated_title( $args = null, $escape = true, $social = false ) {

		// We should always get something from here.
		$title = \tsf()->s_title_raw( static::get_bare_generated_title( $args ) );
	...
	public static function get_bare_custom_title( $args = null ) {
		...
		return (string) \apply_filters_ref_array(
			...
			[
				static::get_bare_unfiltered_custom_title( $args ),
				$args,
			]
		);
	}
	...
	public static function get_bare_generated_title( $args = null ) {
		...
		return (string) \apply_filters_ref_array(
			...
			[
				static::get_bare_unfiltered_generated_title( $args ),
				$args,
			]
		);
	}
	...
	public static function get_custom_title_from_query() {
		...
		if ( Query::is_real_front_page() ) {
			...
			$title = \tsf()->get_term_meta_item( 'doctitle' );
			...
			$title = (string) \apply_filters_deprecated(
				...
				[ \tsf()->get_post_type_archive_meta_item( 'doctitle' ) ],
	 ...
	 */
	public static function get_bare_unfiltered_generated_title( $args = null ) {
		...
		return memo( $title ?: static::get_untitled_title(), $args );
	}
	/**
	...
	public static function generate_title_from_query() {
		...
		} elseif ( Query::is_real_front_page() ) {
	...
	public static function get_archive_title( $object = null ) {
		...
		[ $title ] = static::get_archive_title_list( $object );
	...
	public static function get_archive_title_from_query() {
		...
		if ( Query::is_category() ) {
			$title  = static::get_term_title( \get_queried_object() );
	 ...
	 * @since 4.3.0
	 *
	 * @param \WP_Term|\WP_User $object The Term object.
	 * @return string[$title,$prefix] The title and prefix.
	 */
	public static function get_archive_title_from_object( $object ) {
		...
		} elseif ( $object instanceof \WP_User && isset( $object->display_name ) ) {
