...
class Generate_Title extends Generate_Description {
	 ...
	 *
	 * @since 3.1.0
	 * @uses $this->get_title_from_custom_field()
	...
	public function get_title( $args = null, $escape = true ) {
		...
		$title = $this->get_title_from_custom_field( $args )
	 ...
	 */
	public function get_title_from_custom_field( $args = null, $escape = true ) {
		...
		$title = (string) \apply_filters_ref_array( 'the_seo_framework_title_from_custom_field', [
			$this->get_unprocessed_title_from_custom_field( $args ),
			$args,
			null,
		] );
	...
	public function get_generated_title( $args = null, $escape = true ) {
		 ...
		 * @param array  $args  The title arguments.
		 */
		$title = (string) \apply_filters_ref_array( 'the_seo_framework_generated_title', [
			$this->get_unprocessed_title_from_generation( $args ),
			$args,
		] );
	...
	public function get_generated_open_graph_title( $args = null, $escape = true ) {
		...
		$title = $this->get_generated_title( $args, false );
	 ...
	 */
	public function get_unprocessed_title_from_custom_field( $args = null ) {
	 ...
	 */
	public function get_unprocessed_title_from_generation( $args = null ) {
	 ...
	 * @since 3.1.0
	 * @internal
	 * @see $this->get_unprocessed_title_from_generation()
	 *
	 * @return string The generated title.
	 */
